...
% Warunki początkowe:
Tzew0 = TzewN;      %Poczatkawa temperetura zewnetrzna
Tkz0 = TkzN + i;        %Poczatkowa temperatura dostarczanego powietrza
Tg0 = TgN;          %Poczatkowa temperatura gruntu
fp0 = fp * (10 - i) / 10;
...
dTg = 0;            %Zaklocenie temperatury gruntu
dTkz = 0;           %Zaklocenie temperatury dostarczanego powietrza
dfp = fp * (i/10);       %Zaklocenie przeplywu powietrza
...
subplot(2,1,1);
hold on;
plot(TrTime,TrTwew,'LineWidth',5);
xlabel('Czas [s]');
ylabel('Temperatura [{\circ} C]');
title('Temperatura pokoju - Nieliniowe');
set(gca, 'FontSize',20);
